...
Sou **William Daniel Schwarz**, desenvolvedor **Full Stack Flutter** no **Grupo K1**. Tenho paixão por criar soluções que realmente **geram impacto** — seja no **mobile**, **web**, ou no **back-end**. Acredito que tecnologia bem aplicada transforma experiências, processos e vidas. Vamos inovar juntos? 💡

---

## 👨‍💻 Sobre mim

- 📱 **Dev em Flutter e Dart**, com foco em aplicações **mobile e web** de alta performance.
- 🛠️ Experiência prática com **SQL Server** como DBA e projetos sólidos com **Firebase** e **Supabase**.
- 🧩 Já atuei com **Node.js** e **Docker** para construção de APIs e containers básicos.
...
- 🔗 [Meu LinkedIn](https://www.linkedin.com/in/william-schwarz-55705b239/)
